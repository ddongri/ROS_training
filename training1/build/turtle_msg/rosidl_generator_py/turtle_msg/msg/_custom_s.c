...
bool turtle_msg__msg__custom__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "turtle_msg.msg._custom.Custom",
        full_classname_dest, 29) == 0);
  }
  turtle_msg__msg__Custom * ros_message = _ros_message;
  {  // radius
...
PyObject * turtle_msg__msg__custom__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_msg.msg._custom");
