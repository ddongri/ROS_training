...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Custom_message_member_array[3] = {
  {
    ...
    offsetof(turtle_msg::msg::Custom, radius),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_msg::msg::Custom, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_msg::msg::Custom, direction),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Custom_message_members = {
  "turtle_msg::msg",  // message namespace
  "Custom",  // message name
  3,  // number of fields
  sizeof(turtle_msg::msg::Custom),
...
{
  return &::turtle_msg::msg::rosidl_typesupport_introspection_cpp::Custom_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_msg, msg, Custom)() {
  return &::turtle_msg::msg::rosidl_typesupport_introspection_cpp::Custom_message_type_support_handle;
}
